...
namespace SqliteSample
{
    public class DBHelper
    {
        ...
        //Create Operation
        public void Create<T>(string statement) where T : new()
        {
            try
            {
                Open();
            ...
            {
                {
                    System.Diagnostics.Debug.WriteLine("Creation failed: " + ex.Message);
                    throw ex;
                }
            }
        }
        ...
        public void InsertNewRow(string statement)
        {
            try
            {
                Open();
